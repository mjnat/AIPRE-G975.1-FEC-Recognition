...
def encode_I4_RS_BCH_exact(raw_bits, g_inner):
    ...
    rs_outer_i4 = galois.ReedSolomon(1023, 1007, field=GF10, first_root=0)
...
def encode_I8_RS_exact(raw_bits):
    ...
    rs_i8 = galois.ReedSolomon(4095, 3925, field=GF12, first_root=0) 
...
def generate_standard_sovereign_frame(cls, osnr, g_i3_o, g_i3_i, g_i4_i, g_i7_r, g_i7_c, G_mat, T_i9):
    ...
    try:
        if cls == 0:   # I.1: RS(255,239) کلاسیک روی GF256
            rs = galois.ReedSolomon(255, 239, field=GF256, first_root=0)
            ...
            rs_outer = galois.ReedSolomon(1901, 1855, field=GF11, first_root=1001)
